...
/**
 * กิจกรรมที่ยังไม่ถูกลบ — ใช้ต่อท้าย where ของทุกหน้าที่ผู้ใช้เลือกดูกิจกรรมได้
 *
 * หน้าสาธารณะและหน้าของนิสิตไม่ได้ใช้ ownedActivityFilter จึงต้องมีตัวกรองกลางอีกตัว
 * ที่นี่ เพื่อไม่ให้แต่ละหน้าเขียน deletedAt: null เองแล้วมีหน้าที่ลืม
 *
 * ตั้งใจไม่กรองเส้นทางที่เข้าถึงกิจกรรมผ่านใบลงทะเบียน (ประวัติชั่วโมง ใบประกาศ
 * รายการที่เคยสมัคร) เพราะประวัติของนิสิตต้องยังบอกได้ว่าชั่วโมงมาจากกิจกรรมอะไร
 * แม้กิจกรรมนั้นจะถูกลบไปแล้ว
 */
